export default function ContactSection() {
  return (
    <div className="isolate bg-[url('/eventflow-hero-bg.jpg')] bg-cover px-6 py-24 sm:py-32 lg:px-8">
      {/* <div
        aria-hidden="true"
        className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80 bg-black"
      > */}
      {/* <div
          style={{
            clipPath:
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-2.5">
                <input
                  ...
                  className="block w-full rsvp-input rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500"
                />
              </div>
            </div>
            <div className="sm:col-span-2">
              ...
              <div className="mt-2.5">
                <input
                  ...
                  name="email"
                  autoComplete="email"
                  className="block rsvp-input w-full rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500"
                />
              </div>
            </div>
            <div className="sm:col-span-2">
              ...
              <div className="mt-2.5">
                <div className="flex rsvp-input rounded-md bg-white/5 outline-1 -outline-offset-1 outline-white/10 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-500">
